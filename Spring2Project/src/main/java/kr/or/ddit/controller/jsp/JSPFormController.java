...
public class JSPFormController {
	 ...
	 * 		import			|	JSP페이지가 세션을 사용할지의 여부를 지정한다.
	 * 		─────────────────────────────────────────────────────────────────────
	 * 
	 * 		2) taglib 지시자
	 ...
	 * 			속성			|		설명
	 * 		─────────────────────────────────────────────────────────────────────
	 * 			prefix		|	태그 라이브러리를 호출할 때 사용할 접두러를 지정한다.
     ...
     *      - 현재는 스크립틀릿을 사용하기 보다는 JSTL과같은 커스텀 태그 라이브러리와 EL을 조합해서 JSP를 구현하는 방법을 많이 사용한다. 
	 * 
	 * 		3. 커스텀 태그 라이브러리
	 ...
	 * 
	 * 			** true 조건 :::
	 * 			- null값, 빈 문자역(""), 길이가 0인 배역, 빈 collection
	 * 
	 * 		# 논리 연산자
	 * 			연산자	|	설명
	 * 		─────────────────────────────────────────────────────────────────────────────
	 * 			&&(and)	|	두 피연산자 모두 true이면 bool true를 반환하고, 그렇지 않으면 false 
	 * 			||(or)	|	두 피연산자 중 하나 또는 모두 true이면 bool true를 반환하고, 그렇지 않으면 false 
